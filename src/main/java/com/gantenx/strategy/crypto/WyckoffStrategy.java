...
public class WyckoffStrategy extends BaseCryptoStrategy {
    ...
    public WyckoffStrategy(CryptoSymbol symbol, String start, String end) {
        super(WyckoffStrategy.class.getSimpleName(), symbol, start, end);
        this.timestamps = CollectionUtils.getTimestamps(klineMap);
    }
    ...
    protected void openTrade() {
        ...
        for (long timestamp : timestamps) {
            ...
            if (inAccumulationPhase && !hasPosition && close < lastSupport * (1 + SUPPORT_THRESHOLD)) {
                ...
                tradeEngine.buy(symbol, close, PROPORTION_OF_10, timestamp, "Wyckoff Accumulation Buy");
                hasPosition = true;
            }
            ...
            if (inAccumulationPhase && hasPosition && close > lastResistance * (1 - RESISTANCE_THRESHOLD)) {
                ...
                tradeEngine.sell(symbol, close, PROPORTION_OF_10, timestamp, "Wyckoff Accumulation Sell");
                hasPosition = false;
            }
        }
    }
